...
export const EXTRA_SPEED: SpeedChallenge[] = [
  ...
  { id: "spd-012", type: "speed", category: "evenements", difficulty: "facile", title: "Création", description: "", prompt: "En combien de jours Dieu acheva la création visible ?", answer: "6|six", timeLimitSeconds: 8, sources: bible("Genèse 1:31"), verifiedAt: VERIFIED, tags: [] },
  { id: "spd-013", type: "speed", category: "evenements", difficulty: "moyen", title: "Babel", description: "", prompt: "Comment s'appelait la tour où les langues furent confondues ?", answer: "Babel", timeLimitSeconds: 10, sources: bible("Genèse 11:9"), verifiedAt: VERIFIED, tags: [] },
  ...
  { id: "spd-015", type: "speed", category: "versets", difficulty: "moyen", title: "Matthieu 6:33", description: "", prompt: "Que faut-il chercher en priorité selon Matthieu 6:33 ?", answer: "royaume|le royaume", timeLimitSeconds: 12, sources: bible("Matthieu 6:33"), verifiedAt: VERIFIED, tags: [] },
  { id: "spd-016", type: "speed", category: "livres", difficulty: "facile", title: "Dernier livre", description: "", prompt: "Quel est le dernier livre de la Bible ?", answer: "Révélation|Apocalypse|revelation", timeLimitSeconds: 10, sources: jwLib("Appendice A3 — Livres de la Bible"), verifiedAt: VERIFIED, tags: [] },
  { id: "spd-017", type: "speed", category: "geographie", difficulty: "moyen", title: "Baptême", description: "", prompt: "Dans quelle rivière Jésus fut-il baptisé ?", answer: "Jourdain", timeLimitSeconds: 10, sources: bible("Matthieu 3:13"), verifiedAt: VERIFIED, tags: [] },
